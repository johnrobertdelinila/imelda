...
<style>
  .btn-group-lg>.btn, .btn-lg {
    ...
    border-radius: 6px;      
        ...
        <p>
            <center>  <font face="Gordana" size="4">Republic of the Philippines <br> Department of Interior and Local Government <br>Province of La Union <br> Municipality of Imelda <br>  <label> BARANGAY </label>    <input type="text" name="barangay" value="<?php echo $brgy;?>"> </font>
        </p>
          <p>
            <br>
