 ...
 <header>
    ...
    <div class="whole">
     ...
     <center>
         ...
         <font face="Gordana" size="3">IMELDA RIVER AND ESTERO CLEAN UP PROJECT <br>Quarter: <input type="text" name="quarter" size="5" required> Quarter Year: <input type="text" name="year" required ></font>
    <br> <br>
   ...
   <br>
    ...
    <div class="col-sm-6" >
       <label1 for="exampleInputName2">Name of Barangay:</label1>
        <input  class="form-control111" name="brgyname" type="text" value="Imelda" disabled required>
                 <br>
                <br>
                <label1 for="exampleInputName2">Provincial Location:La Union</label1>
    ...
    <div class="col-sm-6" >
      <label1 for="exampleInputName2">Municipality: NAGUILIAN</label1>
                
                 <br>
                <br>
                <label1 for="exampleInputName2">Regional Location:I</label1>
