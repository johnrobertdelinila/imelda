...
$pdf->Cell(50,5,"",5,5,'C');  
$pdf->Cell(200,5,"IMELDA RIVER AND ESTERO CLEAN UP PROJECTT", 5,5,'C');
$quat=$_POST['quarter'];
$year=$_POST['year'];
...
$pdf->Cell(50,5,"Name of Barangay: $brgyname                                                Municipality:NAGUILIAN ",5,5,'');
    

$pdf->Cell(50,5,"Provincial location: LA UNION                                    Regional location:I ",5,5,'');
