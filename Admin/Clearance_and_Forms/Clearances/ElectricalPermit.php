...
$sqlsli = "INSERT INTO form_release (res_ID, form_ID, purpose_ID, release_date)
         VALUES ('$res_IDnow', 38, '$ORCTC','$datedate');";
        ...
        <div class="c-wrapper">
          ...
          <div class="content">
            <div id="par">
              ...
              &emsp;&emsp;&emsp;This is to certify that the application for the construction of electrical connection of
              <span id="name-input">residential building / commercial and / or industrial establishment</span>.<br><br>
              &emsp;&emsp;&emsp;Applied by Mr. / Ms. /  Mrs.  <span id="name-input"><?php echo $first." ".$middleName." ".$lastName; ?></span>
              with the jurisdiction of <span id="name-input"><?php echo $brgy." ".$city.","." ".$province;?></span>
              is hereby granted to the rules and regulation provided for the existing Zoning Ordinance of the Barangay, the National Building Code and other related Agencies.<br><br>

              &emsp;&emsp;&emsp;Issued this day <span id="name-input"><?php echo $datedate?></span> at <span id="name-input"><?php echo $head_brgy_Name." ".$citymun_disp.","." ".$province_disp;?></span>.

            </div>

              <div class="ccon margint">
                <div class="puno">
                  <span id="name-input"><?php echo $capfName." ".$capmInitial."."." ".$caplName;?></span><br>
