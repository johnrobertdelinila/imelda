...
$sqlsli = "INSERT INTO form_release (res_ID, form_ID, purpose_ID, release_date)
         VALUES ('$res_IDnow', 37, '$ORCTC','$datedate');";
...
<html>
  <header>
    <title>Clearance for Cutting Trees</title>
  ...
  <body>
    <div id="main-container">
      ...
      <div class="header tag1">
        BARANGAY CLEARANCE FOR CUTTING TREES
      </div>
        <div class="c-wrapper">
          ...
          <div class="content">
            <div id="par">
              ...
              &emsp;&emsp;&emsp;This is to certify that the request of Mr. / Mrs. <span id="name-input"><?php echo $first." ".$middleName." ".$lastName; ?></span>
               of legal age, to cut tree / trees within his / her property jurisdiction is hereby granted based on the following terms and conditions as follows,
              to wit;<br><br>

              &emsp;&emsp;&emsp;1. That the tree / trees to be cut is / are not within the prohibited area of twenty meters (20m) from the river
              banks or watershed areas;<br><br>

              &emsp;&emsp;&emsp;2. It affects the productiveness of nearby high value commercial crops planted;<br><br>
              &emsp;&emsp;&emsp;3. May pose danger to life;<br><br>

              &emsp;&emsp;&emsp;4. That this clearance is just a requisuite in securing permit to cut from MENRO, PCA, CENRO / PENRO and other concerned
              agencies. <br><br>

              &emsp;&emsp;&emsp;Issued this <span id="name-input"><?php echo $datedate;?></span> as for his / her information and reference.

            </div>

              <div class="signature signline center margint100">APPLICANT'S SIGNATURE</div>
              <div class="ccon">
                <div class="puno">
                  <span id="name-input"><?php echo $capfName." ".$capmInitial."."." ".$caplName;?></span><br>
