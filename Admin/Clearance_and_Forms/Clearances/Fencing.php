...
$sqlsli = "INSERT INTO form_release (res_ID, form_ID, purpose_ID, release_date)
         VALUES ('$res_IDnow', '$ORCTC', 1,'$datedate');";
  ...
  <body>
    <div id="main-container">
      ...
      <div class="header tag1">
        BARANGAY CLEARANCE FOR FENCING PERMIT
      </div>
        <div class="c-wrapper">
          ...
          <div class="content">
            <div id="par">
              ...
              &emsp;&emsp;&emsp;The aforementioned address and location to be fenced should be legally titled or domain of the owner.<br><br>

              &emsp;&emsp;&emsp;Issued this <span id="name-input"><?php echo $datedate?> at Barangay <span id="name-input"><span id="name-input"><?php echo $head_brgy_Name." ".$citymun_disp.","." ".$province_disp;?></span>.
