...
if($print=="All")
{
$query = "SELECT * from annual_project where `source` ='Barangay Disaster Risk Reduction Management Fund'";	
...
{
	$query = "SELECT * from annual_project WHERE `source` ='Barangay Disaster Risk Reduction Management Fund' and start like '%$print%' or end like '%$print%'";
	$query1 = "SELECT SUM(amount) from annual_project where `source` ='Barangay Disaster Risk Reduction Management Fund' and (start like '%$print%' or end like '%$print%')";
